...
class ProductControl extends Component {
    ...
    componentDidMount(){
        axios.get('http://127.0.0.1:62209/api/products')
            .then(res =>{
                console.log(res)
                this.setState({
    ...
    handleAddingNewProduct = (newProduct) =>{
        ...
        // }       
        // console.log(...formData)
        axios.post('http://127.0.0.1:62209/api/products', newProduct)
    ...
    handleDeletingProduct = (id) =>{
        axios.delete('http://127.0.0.1:62209/api/products/'+id)
            .then(res => console.log(res.data))
            .catch((error) =>{
                console.log(error)
            })
    ...
    //http://127.0.0.1:62209/api/products
    ...
    handleEditingProduct = (editedProduct) =>{
        ...
        axios.put('http://127.0.0.1:62209/api/products/' + this.state.selectedProduct._id, editedProduct)
            .then(res =>console.log(res.data))
